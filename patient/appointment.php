                ...
                <div class="col-md-10">
                    ...
                    if (isset($_POST['book'])) {
                        ...
                        if (empty($sym)) {
                            ...
                            $query = "INSERT INTO appointment(firstname,surname,gender,phone,
                                appointment_date,symptoms,status,date_booked) 
                                VALUES('$firstname', '$surname', '$gender', '$phone', '$date', '$sym', 'pending', NOW())";

                            $res = mysqli_query($connect, $query);

                            if ($res) {
                                echo "<script>alert('You have successffully booked an appointment.')</script>";
                            }
                        }
                    }
